...
void setTrims(void) // Set all 4 trim values
{
...
void help(void) // printout the help screen
{
...
void processChar(char c) // process the user input char
{
...
{
  Otto.home();
  while(Serial.available() > 0)  // get input from Serial port
  {
