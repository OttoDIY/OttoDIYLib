...
SerialCommandAI::SerialCommandAI()
{
...
//
void SerialCommandAI::clearBuffer()
{
...
void SerialCommandAI::readSerial() 
{
...
void SerialCommandAI::addCommand(const char *command, void (*function)())
{
...
void SerialCommandAI::addDefaultHandler(void (*function)())
{
